...
counts = counts.replace('None',
                        '0_stewards')  # Replace steward="None" with "0_stewards" so that this level will be first in the plot. Realize this is a bit messy, but was running into issues when I made this just '0'.
...
app.layout = html.Div(children=[
    html.H1(children='Health of Various Tree Species - A Dash App'),
